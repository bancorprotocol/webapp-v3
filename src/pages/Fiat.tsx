...
{
    name: 'Everest',
    text: 'Everest is as a global fiat-to-crypto payment gateway and crypt-to-fiat provider. We help new and returning visitors to easily access crypto. Based in Europe, Everest conforms to the European regulatory compliance regime enabling consumers from around the world to take advantage of our services.',
    logo: everestLogo,
    operations: [Operations.fiatIn, Operations.fiatOut],
    depositMethods: [
      DepositMethods.debitCard,
