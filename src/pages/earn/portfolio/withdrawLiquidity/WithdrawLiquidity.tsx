              ...
              <div className="px-10 pb-10">
                ...
                <div className="border border-warning rounded bg-warning bg-opacity-[5%] dark:bg-blue-2 dark:bg-opacity-100 p-20 text-12 mt-20">
                  ...
                  <p className="text-grey-4 dark:text-grey-3 ml-20 mt-5">
                    You still haven’t reached full protection. There is a risk
                    for impermanent loss and you might receive less than your
                    original stake amount as a result. Withdrawing will reset
                    your rewards multiplier for all active positions back to x1
                  </p>
                </div>
                <div className="my-20">
                ...
                <div className="mt-20">
                  BNT withdrawals are subject to a 24h lock period before they
                  can be claimed.
                </div>
                <button
                  onClick={() => {}}
