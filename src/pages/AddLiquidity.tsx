...
export const AddLiquidity = (
    ...
    const poolHasLiquidity = foundPool.reserves.some(reserve => new BigNumber(reserve.balance).gt(0))
    console.log({foundPool, poolHasLiquidity})

    return poolHasLiquidity ? <AddProtectionDoubleLiq anchor={anchor} /> : <AddProtectionDouble anchor={anchor} />
